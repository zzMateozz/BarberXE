...
const Navbar = ({ toggleSidebar, isCollapsed }) => {
  ...
  return (
    <header
      className={`bg-zinc-900 border-b border-zinc-800 px-4 h-14 flex justify-between items-center transition-all duration-300 ${
    ...
    >
      <div className="flex items-center">
        ...
        <h1 className="ml-4 text-base font-medium text-white">Cajero</h1>
      </div>
        ...
        {showUserDropdown && (
          <div className="absolute right-0 mt-2 w-48 bg-zinc-800 border border-zinc-700 rounded-md shadow-lg overflow-hidden z-50 animate-in fade-in slide-in-from-top-5 duration-200">
            <div className="px-4 py-3 border-b border-zinc-700">
              ...
              <p className="text-sm font-medium text-white truncate">Cajero</p>
            </div>
            <button
